...
internal static partial class TestRegistry
{
    ...
    Test("ACME renewal configuration input mapper attaches only ACME active certificates", Sync(AcmeTests.AcmeRenewalConfigurationInputMapperAttachesOnlyAcmeActiveCertificates), TestTaxonomy.Tls, TestTaxonomy.Config),
