...
internal static partial class TestRegistry
{
    ...
    Test("ACME request and status records copy input collections", Sync(AcmeTests.AcmeRequestAndStatusRecordsCopyInputCollections), TestTaxonomy.Tls, TestTaxonomy.Config),
    Test("ACME lifecycle status consumes active certificate dates", Sync(AcmeTests.AcmeLifecycleStatusConsumesActiveCertificateDates), TestTaxonomy.Tls, TestTaxonomy.Config),
    ...
    Test("ACME runtime certificate status mapper reads sources without configuration snapshot", Sync(AcmeTests.AcmeRuntimeCertificateStatusMapperReadsSourcesWithoutConfigurationSnapshot), TestTaxonomy.Tls, TestTaxonomy.Config),
    Test("ACME status configuration source mapper reads runtime facts without snapshot", Sync(AcmeTests.AcmeStatusConfigurationSourceMapperReadsRuntimeFactsWithoutSnapshot), TestTaxonomy.Tls, TestTaxonomy.Config),
    ...
    Test("ACME renewal schedule rejects null inputs", Sync(AcmeTests.AcmeRenewalScheduleRejectsNullInputs), TestTaxonomy.Tls, TestTaxonomy.Config),
    ...
    Test("Cache response and status copy input collections", Sync(CacheTests.CacheResponseAndStatusCopyInputCollections), TestTaxonomy.Caching),
    ...
    Test("Cache status reader shapes routes and rejections", Sync(CacheTests.CacheStatusReaderShapesRoutesAndRejections), TestTaxonomy.Caching),
    ...
    Test("Cache store rejects null inputs", Sync(CacheTests.CacheStoreRejectsNullInputs), TestTaxonomy.Caching, TestTaxonomy.SecurityNegativePaths),
    ...
    Test("Request context runtime mapper rejects null inputs", Sync(RouteDiagnosticsTests.RequestContextRuntimeMapperRejectsNullInputs), TestTaxonomy.Routing, TestTaxonomy.Metrics, TestTaxonomy.SecurityNegativePaths),
    ...
    Test("Request context records tunnel completion", Sync(RouteDiagnosticsTests.RequestContextRecordsTunnelCompletion), TestTaxonomy.Routing, TestTaxonomy.Metrics),
    Test("Request context records client disconnect", Sync(RouteDiagnosticsTests.RequestContextRecordsClientDisconnect), TestTaxonomy.Routing, TestTaxonomy.Metrics),
    Test("Request context records upgrade request", Sync(RouteDiagnosticsTests.RequestContextRecordsUpgradeRequest), TestTaxonomy.Routing, TestTaxonomy.Metrics),
    Test("Request context records client connection close", Sync(RouteDiagnosticsTests.RequestContextRecordsClientConnectionClose), TestTaxonomy.Routing, TestTaxonomy.Metrics),
    ...
    Test("Route diagnostics service selects listener before policy explanation", Sync(RouteDiagnosticsTests.RouteDiagnosticsServiceSelectsListenerBeforePolicyExplanation), TestTaxonomy.Routing),
    Test("Route diagnostics service redacts sensitive headers before adapters", Sync(RouteDiagnosticsTests.RouteDiagnosticsServiceRedactsSensitiveHeadersBeforeAdapters), TestTaxonomy.Routing, TestTaxonomy.Headers, TestTaxonomy.SecurityNegativePaths),
    ...
    Test("Config lint runtime source facts reject invalid values", Sync(RouteDiagnosticsTests.ConfigLintRuntimeSourceFactsRejectInvalidValues), TestTaxonomy.Config, TestTaxonomy.Routing, TestTaxonomy.SecurityNegativePaths),
    ...
    Test("Config lint submitted request decision rejects invalid facts", Sync(RouteDiagnosticsTests.ConfigLintSubmittedRequestDecisionRejectsInvalidFacts), TestTaxonomy.Config, TestTaxonomy.Routing, TestTaxonomy.SecurityNegativePaths),
    Test("Config lint submitted request reader rejects missing request", Sync(RouteDiagnosticsTests.ConfigLintSubmittedRequestReaderRejectsMissingRequest), TestTaxonomy.Config, TestTaxonomy.Routing, TestTaxonomy.SecurityNegativePaths),
