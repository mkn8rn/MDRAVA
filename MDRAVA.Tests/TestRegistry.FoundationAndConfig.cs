...
internal static partial class TestRegistry
{
    ...
    Test("Site options aggregator copies input collections", Sync(ConfigurationTests.SiteOptionsAggregatorCopiesInputCollections), TestTaxonomy.Config),
    Test("Site options aggregator copies merged listener SNI entries", Sync(ConfigurationTests.SiteOptionsAggregatorCopiesMergedListenerSniEntries), TestTaxonomy.Config),
    ...
    Test("HTTP heads copy input header lists", Sync(Http1RequestParserTests.HttpHeadsCopyInputHeaderLists), TestTaxonomy.Http1, TestTaxonomy.Headers, TestTaxonomy.Routing),
    ...
    Test("Framed upstream response input copies headers", Sync(FramedUpstreamResponsePolicyTests.TranslationInputCopiesHeaders), TestTaxonomy.Http1, TestTaxonomy.Headers),
    ...
    Test("Header runtime mappers reject null inputs", Sync(HeaderPolicyTests.HeaderRuntimeMappersRejectNullInputs), TestTaxonomy.Headers, TestTaxonomy.Config, TestTaxonomy.SecurityNegativePaths),
    Test("Forwarded headers context copies headers", Sync(HeaderPolicyTests.ForwardedHeadersContextCopiesHeaders), TestTaxonomy.Headers),
