...
internal static partial class TestRegistry
{
    ...
    Test("Runtime state copies listener lists on write and read", Sync(OperatorStatusTests.RuntimeStateCopiesListenerListsOnWriteAndRead), TestTaxonomy.Admin, TestTaxonomy.Config),
        Test("Status configuration summary mapper reads counts without runtime configuration objects", Sync(OperatorStatusTests.StatusConfigurationSummaryMapperReadsCountsWithoutRuntimeConfigurationObjects), TestTaxonomy.Admin, TestTaxonomy.Config),
    Test("Status configuration source mapper shapes status facts from runtime facts without snapshot", Sync(OperatorStatusTests.StatusConfigurationSourceMapperShapesStatusFactsFromRuntimeFactsWithoutSnapshot), TestTaxonomy.Admin, TestTaxonomy.Config),
    ...
    Test("Status readiness inputs copy source lists", Sync(OperatorStatusTests.StatusReadinessInputsCopySourceLists), TestTaxonomy.Admin, TestTaxonomy.Config, TestTaxonomy.Metrics),
    ...
    Test("Status readiness configuration source mapper reads enumerable facts without snapshot", Sync(OperatorStatusTests.StatusReadinessConfigurationSourceMapperReadsEnumerableFactsWithoutSnapshot), TestTaxonomy.Admin, TestTaxonomy.Config),
    ...
    Test("Subsystem summary source mappers copy projected lists", Sync(OperatorStatusTests.SubsystemSummarySourceMappersCopyProjectedLists), TestTaxonomy.Admin, TestTaxonomy.Config, TestTaxonomy.Metrics),
    ...
    Test("Status protocol subsystem summary owns unsupported feature list", Sync(OperatorStatusTests.StatusProtocolSubsystemSummaryOwnsUnsupportedFeatureList), TestTaxonomy.Admin, TestTaxonomy.Http3),
    Test("Status protocol subsystem response owns unsupported feature list", Sync(OperatorStatusTests.StatusProtocolSubsystemResponseOwnsUnsupportedFeatureList), TestTaxonomy.Admin, TestTaxonomy.Http3),
