...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("Config lint reports upstream HTTP/3 final limitations", Sync(RouteDiagnosticsTests.LintReportsUpstreamHttp3FinalLimitations)),
    ...
    ("Upstream HTTP/3 effective projection reports one request per connection", UpstreamHttp3Tests.Http3EffectiveProjectionReportsOneRequestPerConnection),
    ...
    ("Final HTTP/3 support projection reports matrix and limitations", Sync(Http3InfrastructureTests.FinalSupportProjectionReportsHttp3MatrixAndLimitations)),
