...
var tests = new TestCase[]
{
    ...
    Test("Stable HTTP/3 aliases validate map and aggregate consistently", Sync(Http3InfrastructureTests.StableHttp3AliasesValidateMapAndAggregateConsistently), TestTaxonomy.Http3, TestTaxonomy.Config),
    ...
    Test("Status and effective config preserve legacy HTTP/3 preview projection", Sync(ClientHttp3Tests.StatusAndEffectiveConfigPreserveLegacyHttp3PreviewProjection), TestTaxonomy.Http3, TestTaxonomy.Config),
    Test("HTTP/3 beta enablement is explicitly projected", Sync(ClientHttp3Tests.Http3BetaEnablementIsExplicitlyProjected), TestTaxonomy.Http3),
