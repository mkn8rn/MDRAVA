...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("HTTP/3 preview listener protocol is rejected", Sync(Http3EvaluationTests.ListenerProtocolRejectsHttp3Preview)),
    ("HTTP/3 upstream protocol is rejected", Sync(Http3EvaluationTests.UpstreamProtocolRejectsHttp3)),
    ("Existing HTTP/1.1 and HTTP/2 listener protocols still validate", Sync(Http3EvaluationTests.ExistingHttp1AndHttp2ProtocolsStillValidate)),
