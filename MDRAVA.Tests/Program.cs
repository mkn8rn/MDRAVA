...
var tests = new TestCase[]
{
    ...
    Test("HTTP/3 protocol does not require experimental gate for default enablement", Sync(Http3InfrastructureTests.Http3ProtocolDoesNotRequireExperimentalGateForDefaultEnablement), TestTaxonomy.Http3, TestTaxonomy.Config, TestTaxonomy.Admin),
    ...
    Test("HTTP/3 legacy buffered request body limit does not block streaming", ClientHttp3Tests.Http3LegacyBufferedRequestBodyLimitDoesNotBlockStreaming, TestTaxonomy.Http3, TestTaxonomy.Limits),
