...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("HTTP/3 preview is disabled by default", Sync(Http3InfrastructureTests.Http3PreviewIsDisabledByDefault)),
    ("HTTP/3 preview config is rejected without experimental gate", Sync(Http3InfrastructureTests.Http3PreviewConfigIsRejectedWithoutExperimentalGate)),
    ...
    ("HTTP/3 preview remains disabled by default", Sync(ClientHttp3PreviewTests.Http3PreviewDisabledByDefault)),
    ("HTTP/3 preview requires explicit experimental gate", Sync(ClientHttp3PreviewTests.Http3PreviewRequiresExperimentalGate)),
    ...
    ("HTTP/3 Alt-Svc is absent by default", ClientHttp3PreviewTests.AltSvcIsAbsentByDefault),
    ...
    ("HTTP/3 buffered request body limit applies", ClientHttp3PreviewTests.Http3BufferedRequestBodyLimitApplies),
