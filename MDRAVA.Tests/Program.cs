...
var tests = new (string Name, Func<Task> Run)[]
{
    ...
    ("HTTP/3 preview config is accepted with gate but traffic disabled", Sync(Http3InfrastructureTests.Http3PreviewConfigIsAcceptedWithExplicitGateButTrafficDisabled)),
    ...
    ("Status and effective projection report HTTP/3 scaffolded and disabled", Sync(Http3InfrastructureTests.StatusAndEffectiveProjectionReportHttp3ScaffoldedAndDisabled)),
